  ...
  const handleSaveFormtoDB = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        wp.ajax.send('ElastiForm_create_form', {
          data: {
            nonce: getNonce(),
    ...
    <div className='simple-form-builder'>
      ...
      <div className='button-sub-group-simple-form'>
        ...
        <span className="formname">
          <input type="text" placeholder='Add form name' name='ElastiFormname' className="js-open-modal" id="formName" />
        </span>
      </div>
                      ...
                      <Draggable key={field.uniqueId} draggableId={field.uniqueId} index={index}>
                        {(provided) => (
                          ...
                          >
                            ...
                            >{EditIcon}</button>
                            <button className='form-remove' onClick={() => handleRemoveField(field.uniqueId)}>{DeleteIcon}</button>
                          </div>
                        )}
                      </Draggable>
                    ))}
